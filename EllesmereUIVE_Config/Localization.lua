...
enUS.MSG_SCOPE_CHANGED_COLLECTION_REMOVED = "The scope changed; the alert was moved out of its original group."
enUS.MSG_SAVE_MOVE_FAILED = "The alert could not be moved. The original alert was left unchanged."
zhCN.MSG_SCOPE_CHANGED_COLLECTION_REMOVED = "适用范围已改变，条目已移出原合集。"
zhCN.MSG_SAVE_MOVE_FAILED = "条目移动失败，原条目已保持不变。"
zhTW.MSG_SCOPE_CHANGED_COLLECTION_REMOVED = "適用範圍已變更，項目已移出原合集。"
zhTW.MSG_SAVE_MOVE_FAILED = "項目移動失敗，原項目已保持不變。"
...
enUS.BTN_SYNC_CURRENT_SPEC = "Sync Selected Specs"
enUS.BATCH_SYNCED = "Synced %d/%d"
enUS.BATCH_CONFLICT = "Conflicts %d"
enUS.BATCH_WAITING = "Waiting %d"
enUS.SEARCH_SOUNDS_PLACEHOLDER = "Search sounds"
enUS.NO_MATCHING_SOUNDS = "No matching sounds"
...
zhCN.BTN_SYNC_CURRENT_SPEC = "同步所选专精"
zhCN.BATCH_SYNCED = "已同步 %d/%d"
zhCN.BATCH_CONFLICT = "冲突 %d"
zhCN.BATCH_WAITING = "等待 %d"
zhCN.SEARCH_SOUNDS_PLACEHOLDER = "搜索声音"
zhCN.NO_MATCHING_SOUNDS = "没有匹配的声音"
...
zhTW.BTN_SYNC_CURRENT_SPEC = "同步所選專精"
zhTW.BATCH_SYNCED = "已同步 %d/%d"
zhTW.BATCH_CONFLICT = "衝突 %d"
zhTW.BATCH_WAITING = "等待 %d"
zhTW.SEARCH_SOUNDS_PLACEHOLDER = "搜尋聲音"
zhTW.NO_MATCHING_SOUNDS = "沒有相符的聲音"
